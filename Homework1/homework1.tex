...
To simulate a move to the left cell, I will be able to mark the previous cell with the following algorithm:
...
Similarly, I will now prove that this machine can be simulated by a regular Turing Machine.
